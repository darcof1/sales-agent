package sales.agent.repository;

import sales.agent.SalesAgentsApp;
import sales.agent.config.Constants;
import sales.agent.config.TestSecurityConfiguration;
import sales.agent.config.audit.AuditEventConverter;
import sales.agent.domain.PersistentAuditEvent;
...
import static sales.agent.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
